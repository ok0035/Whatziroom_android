...
public class SearchAdapter extends ArrayAdapter {
    ...
    ArrayList<MapData> searchList = null;

    public SearchAdapter(@NonNull Context context, ArrayList<MapData> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        MapData data = searchList.get(position);
        ...
        if(!data.getImageUrl().equals("")) {
            ...
            Glide.with(SearchPlaceActivity.searchActivity).load(data.getImageUrl()).apply(RequestOptions.circleCropTransform()).into(ivSearch);
