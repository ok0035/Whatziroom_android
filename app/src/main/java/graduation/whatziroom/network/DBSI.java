...
//                System.out.println("moveToNext...." + cursor.moveToNext());
    ...
    private void setDB(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS User (PKey integer(8) NOT NULL, Name varchar(20), ID varchar(20), PW varchar(60), Email varchar(30), " +
                "Status tinyint(3), Acount varchar(30), Longitude double(10), Latitude double(10), CreatedDate timestamp, UpdatedDate timestamp, UUID varchar(200), AutoLogin integer(1), Message varchar(100), FirebaseToken varchar(250), Push integer(1) default 0, Alarm integer(1) default 0);");
